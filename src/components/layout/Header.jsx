          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            {isAuthenticated && (
              <>
                ...
                <Link to="/my-courses" className="px-4 py-2 text-black dark:text-white hover:text-primary-600 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-all duration-200 flex items-center gap-2">
                <BookOpenIcon className="w-5 h-5" />
                  <span>My Cources</span>
                </Link>
                <Link to="/my-doubts" className="px-4 py-2 text-black dark:text-white hover:text-primary-600 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-all duration-200 flex items-center gap-2">
