...
const Profile = () => {
  ...
  const [showChangePassword, setShowChangePassword] = useState(false); // ← MOVED INSIDE COMPONENT
        ...
        <div className="divide-y divide-gray-100 dark:divide-gray-700">
          ...
          <div className="flex items-center gap-4 p-5">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-800 dark:text-white font-medium mt-1 capitalize">
                {user?.role}
              </p>
            </div>
          </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden border border-gray-100 dark:border-gray-700 mb-6">
        ...
        <div className="divide-y divide-gray-100 dark:divide-gray-700">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Dark mode, notifications, and preferences
                </p>
              </div>
            </div>
            <ChevronRightIcon className="w-5 h-5 text-gray-400 group-hover:text-primary-600 transition-colors" />
          ...
          <button
            ...
            className="flex items-center justify-between p-5 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors w-full group"
          >
            <div className="flex items-center gap-4">
